...
class Config(object):
    ...
    # REQUIRED
    TOKEN = "1037378870:AAHXyFWROufifHNuaH_ixARmVMOVfIbnq9s" # Bot Token
    API_ID = "1247282" # Your api id
    API_HASH = "ca5659d2ba9567c4d0b267821c4aeaaa" # Your api hash
    SW_API = "" # Spamwatch Api
    OWNER_ID = "682967056"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "@jackpot3922"
